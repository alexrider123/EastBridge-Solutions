  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        mandate:
          "A top-3 global EV manufacturer engaged East Bridge, working directly with its designated Chinese project owner, to organize the Israel-based program for the introduction of its newest EV model, built around two core pillars: an intelligent driving technical validation project and a market audit event. The manufacturer's product range extends well beyond electric vehicles — spanning battery-electric, plug-in hybrid, and conventional combustion models, built predominantly around SUV and crossover body styles engineered for export, and increasingly defined by its own in-house intelligent-driving and driver-assistance technology. The mandate itself is entirely tailor-made: no existing template to draw on, and no single function it falls under. Beyond the two pillars, the scope also touches regulatory compliance, licensing, in-country logistics, multi-stakeholder program management, and public relations and brand exposure, all at once.",
        approach:
          "We are designing and running the Israel side of the program end-to-end, anchored around the upcoming intelligent driving technical validation project and the market audit event: securing the regulatory approvals needed to bring the vehicle into the country and accompanying its licensing process throughout; coordinating in-country logistics; and managing the full roster of local stakeholders — testing venues, technical partners, and KOLs/KOCs — while reporting directly to the manufacturer's Chinese project owner throughout.",
        challenge:
