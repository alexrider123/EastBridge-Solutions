export const en = {
  meta: {
    title: 'East Bridge Solutions — China–Israel Advisory',
    description:
      'East Bridge Solutions is a trusted advisory and execution partner for Chinese enterprises engaging with Israel.',
    ...
    points: [
      {
        ...
        text: 'Permanently based in Tel Aviv.',
      },
      {
        label: 'Bilateral Expertise',
        text: 'Deep familiarity with Chinese enterprise priorities and the Israeli institutional landscape — developed through direct operating experience on both sides.',
      },
      {
        label: 'Execution-Oriented',
        text: 'We move from advice to action. Engagement can start at any stage and scale as objectives evolve.',
      },
      {
        label: 'Languages',
        text: 'We operate in English, Chinese, and Hebrew.',
      },
      {
        label: 'Academic Foundation',
        text: 'MBA from Tel Aviv University and Hong Kong University of Science and Technology — bridging Israel\'s innovation ecosystem and Asia\'s commercial networks.',
      },
    ],
  },
  ...
  founder: {
    ...
    credentials: [
      {
        area: 'Academic Background',
        detail:
          'MBA from Tel Aviv University (TAU) and Hong Kong University of Science and Technology (HKUST) — a dual-institution programme bridging Israel\'s innovation ecosystem and Asia\'s commercial networks.',
      },
      {
        area: 'Industrial Operations',
        detail:
          'Hands-on experience with global procurement, supply chain, and engineering teams across international manufacturing environments.',
      },
      {
        area: 'Cultural Interface',
        detail:
          'Deep operating familiarity with Israel\'s innovation ecosystem and the practical realities of China–Israel business engagement.',
      },
    ],
  },
    ...
    items: [
      {
        ...
        body: "For companies exploring Israel. We provide low-commitment, diagnostic strategic support to clarify priorities, map stakeholders, and define realistic market-entry options.",
      },
      {
        title: 'Access & Introductions',
      ...
      },
      {
        ...
        body: 'For companies already engaged. We act as your on-the-ground representative in Israel, providing long-term ownership, follow-through, and local accountability.',
      },
    ],
  },
    ...
    items: [
      {
        ...
        body: "The client sought to enter the AI data centers and related infrastructure market, aiming to have its different product lines integrated into the bill of materials for a prominent Mag7 with a major footprint in Israel. We acted as the local representative, interfacing with engineering, product, and procurement teams — coordinating technical discussions, aligning stakeholders, and ensuring requirements and deliverables were clearly defined.",
        outcome:
          "Secured over US$10 million in initial orders.\n2026 revenue target: US$100 million.",
        mandate:
          "A Dongguan-based tier-2 supplier of precision mechanical assemblies and thermal solutions sought to enter the AI data centers and related infrastructure market, aiming to have its different product lines integrated into the bill of materials for a prominent Mag7 with a major footprint in Israel. With 1,600+ employees and operations across six countries, the client brought an established global manufacturing footprint, but Israel represented a market where it had no existing relationships or local presence.",
        approach:
          "We represented our client in Israel, interfacing directly with the customer's engineering, product, and procurement teams — including weekly technical meetings to track progress and keep both sides aligned on requirements. We also met directly with the customer's senior leadership to position our client as a go-to partner and advance commercial terms at the executive level.",
        challenge:
          "Beyond the technical requirements, the real challenge was navigating the procurement hierarchy inside the Mag7 customer. The client's components were being evaluated as the newest addition to a bill of materials built around long-established, qualified suppliers — so earning a foothold meant identifying exactly which stakeholder could open that door, then making the case in terms that mattered to them: technical fit, cost structure, and supply chain reliability, explained with the fluency of someone who genuinely understood the product. Technical credibility alone rarely moves a procurement process at this scale, though — it also took building real working relationships with the engineers and procurement leads evaluating the opportunity, enough that they were willing to champion a new, unproven vendor internally rather than default to the safer, already-qualified alternative.",
        timeline: [
          ...
          { label: 'Landing support requested', description: 'The client asked East Bridge to organize and deliver full on-the-ground support for a senior leadership business trip to Israel, including arranging meetings with the customer.' },
          { label: 'Business trip & first contact', description: 'Client senior leadership traveled to Israel; East Bridge facilitated the first direct meeting with the customer.' },
          { label: 'Confirmed as local representative', description: "East Bridge was confirmed as the client's local representative in Israel, taking responsibility for business development with the customer." },
      ...
      },
      {
        ...
        timeline: [
          ...
          { label: 'Order placed & logistics arranged', description: 'Commercial terms finalized and the order confirmed, with shipment and delivery logistics coordinated to close out the engagement.' },
        ],
      ...
      },
      {
        ...
        timeline: [
          { label: "Initial meeting with the client's senior leadership", description: "Meeting with the client's CEO at their headquarters in Shenzhen, China." },
          { label: 'Defining the opportunity & screening criteria', description: 'Briefed the client on the opportunity to acquire an early-stage Israeli company to support its planned US expansion, and agreed a shared definition of criteria for the initial market analysis and startup identification process.' },
          ...
          { label: 'Negotiation', description: 'Supported negotiation between the client and the single startup selected as the sole go-forward candidate.' },
      ...
      },
      {
        ...
        profile:
          "A top-3 global EV manufacturer, with a broader lineup spanning battery-electric, plug-in hybrid, and combustion models built around export-oriented SUVs and its own in-house intelligent-driving technology, engaged East Bridge, working directly with its designated Chinese project owner, to lead the Israel-side program for the manufacturer's newest EV model introduction.",
        body: "We are designing and running the Israel side of the program, working in close cooperation with the manufacturer's designated Chinese project owner throughout.",
        outcome:
          "Delivering a fully tailor-made program built around two pillars — an upcoming intelligent driving technical validation project and a market audit event — backed by regulatory approval, in-country logistics, and multi-stakeholder coordination, while accompanying the vehicle's licensing process throughout, for the manufacturer's new model introduction in Israel.",
        mandate:
          "A top-3 global EV manufacturer, working directly with its designated Chinese project owner, sought to organize the Israel-based program for the introduction of its newest EV model, built around two core pillars: an intelligent driving technical validation project and a market audit event. The manufacturer's range extends beyond EVs — spanning plug-in hybrid and combustion models too — built mainly around export-oriented SUVs and crossovers with in-house intelligent-driving technology. The mandate itself is entirely tailor-made: no existing template to draw on, and no single function it falls under. Beyond the two pillars, the scope also touches regulatory compliance, licensing, in-country logistics, multi-stakeholder program management, and public relations and brand exposure, all at once.",
        approach:
          "We are designing and running the Israel side of the program, anchored around the upcoming intelligent driving technical validation project and the market audit event: securing the regulatory approvals needed to bring the vehicle into the country and accompanying its licensing process throughout; coordinating in-country logistics; and managing the full roster of local stakeholders — testing venues, technical partners, and KOLs/KOCs — while reporting directly to the manufacturer's Chinese project owner throughout.",
        challenge:
          "There is no existing playbook to work from. Bringing a new EV model, featuring its intelligent driving systems, into Israel for both the upcoming technical validation project and the market audit event means assembling a program from scratch across half a dozen domains that don't normally sit under one roof: import regulation and licensing, logistics, venue and stakeholder coordination, and PR. The vehicle itself adds a further complication: as a pre-production prototype, it doesn't qualify for the standard vehicle import process, and instead requires a separate, special-case licensing route that we are accompanying from scratch. Each domain carries its own local rules and relationships, and the manufacturer needs a single point of accountability across all of them rather than a patchwork of specialist vendors.",
        timeline: [
          ...
          { label: 'Preparing the technical validation project', description: "Coordinating with the manufacturer's Chinese project owner to prepare the intelligent driving technical validation project, still ahead on the program timeline." },
  ...
  footer: {
    tagline: 'Advisory at the China–Israel interface.',
    copyright: '© 2026 East Bridge Solutions. All rights reserved.',
  },
} as const;
