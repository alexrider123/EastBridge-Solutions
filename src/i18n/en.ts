    ...
    items: [
      {
        ...
        body: "The client sought to enter the AI data centers and related infrastructure market, aiming to have its different product lines integrated into the bill of materials for Nvidia's AI data centers. We acted as the local representative, interfacing with engineering, product, and procurement teams — coordinating technical discussions, aligning stakeholders, and ensuring requirements and deliverables were clearly defined.",
        outcome:
          "Secured over US$10 million in initial orders.\n2026 revenue target: US$100 million.",
        mandate:
          "A Dongguan-based tier-2 supplier of precision mechanical assemblies and thermal solutions sought to enter the AI data centers and related infrastructure market, aiming to have its different product lines integrated into the bill of materials for Nvidia's AI data centers. With 1,600+ employees and operations across six countries, the client brought an established global manufacturing footprint, but Israel represented a market where it had no existing relationships or local presence.",
        approach:
